                    ...
                    <form action="{{ route('projek.update', $projek->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                name="name" id="name" value="{{ old('name', $projek->name) }}" autofocus required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mitra') is-invalid @enderror"
                                name="mitra" id="mitra" value="{{ old('mitra', $projek->mitra) }}" autofocus required>
                            @error('mitra')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('storage/' . $projek->thumbnail) }}"
