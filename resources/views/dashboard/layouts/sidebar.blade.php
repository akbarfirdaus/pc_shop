    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::is('dashboard/projek*') ? 'active' : '' }}">
                    <a href="{{ route('projek.index') }}" class='sidebar-link'>
                        <i class="bi bi-kanban-fill"></i>
                        <span>Projek</span>
                    </a>
                </li>

                <li class="sidebar-item {{ Request::is('dashboard/produk*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item  ">
                    <form action="/logout" method="post">
                        ...
                        <button type="submit" class='sidebar-link bg-transparent border-0 w-100 text-start'>
                            <i class="bi bi-arrow-left-square-fill me-3"></i>
                            Logout
                        </button>
                    </form>
                </li>
