            ...
            <div class="frame-group">
                ...
                <div class="home-parent">
                    ...
                    <a href="<?php echo e(route('katalog')); ?>"
                        class="nav-link <?php echo e(Request::is('katalog*') ? 'active' : ''); ?>">Product</a>
                    ...
                    <div class="frame-parent4">
                        <div class="destination-1-parent">
                            <img class="destination-1-icon" alt=""
                                src="<?php echo e(asset('images/destination 1.png')); ?>">
                        ...
                        <div class="destination-1-parent">
                            <img class="destination-1-icon" alt=""
                                src="<?php echo e(asset('images/booking 1.png')); ?>">
                        ...
                        <div class="group-parent">
                            <div class="rectangle-group">
                                ...
                                <img class="arrow-left-1-icon" alt=""
                                    src="<?php echo e(asset('images/arrow-left 1.svg')); ?>">
                            ...
                            <div class="rectangle-container">
                                ...
                                <img class="arrow-left-2-icon" alt=""
                                    src="<?php echo e(asset('images/arrow-left 2.svg')); ?>">
                            </div>
                        </div>
                    </div>
                </section>
                <div class="project-track">
                    <?php $__currentLoopData = $projeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="vector-group">
                            <img class="rectangle-icon" alt="" src="<?php echo e(asset('storage/' . $projek->thumbnail)); ?>">
                            <div class="frame-parent7">
                                <div class="our-project-parent">
                                    <div class="aplikasi-deteksi-apd-di-migas-wrapper">
                                        <b class="aplikasi-deteksi-apd"><?php echo e($projek->name); ?></b>
                                    </div>
                                    <div class="pertamina"><?php echo e($projek->mitra); ?></div>
                                </div>
                        ...
                        <div class="group-parent1">
                            <div class="rectangle-group">
                                ...
                                <img class="icon-check" alt=""
                                    src="<?php echo e(asset('images/centang-kuning.svg')); ?>">
