    		...
    		<div class="frame-parent">
      			<div class="frame-group">
        				...
        				<div class="home-parent">
          					...
          					<a href="<?php echo e(route('katalog')); ?>" class="nav-link <?php echo e(Request::is('katalog*') ? 'active' : ''); ?>">Product</a>
      			...
      			<div class="frame-container">
        				<div class="frame-div">
          					<div class="best-technology-solutions-parent">
            						...
            						<img class="work-1-icon" alt="" src="<?php echo e(asset('images/work 1.svg')); ?>">
          					...
          					<div class="frame-parent1" id="frameContainer1">
            						...
            						<div class="play-circle5-1-parent">
              							<img class="work-1-icon" alt="" src="<?php echo e(asset('images/add-user 1.png')); ?>">
        				...
        				<div class="group-div">
          					<div class="frame-parent2">
            						<div class="rectangle-parent">
              							<img class="frame-child" alt="" src="<?php echo e(asset('images/Rectangle 1.png')); ?>">

              							<img class="frame-child" alt="" src="<?php echo e(asset('images/Rectangle 2.png')); ?>">

            						</div>
            						<img class="frame-inner" alt="" src="<?php echo e(asset('images/Rectangle 3.png')); ?>">

          					</div>
          					<div class="send-1-wrapper">
            						<img class="send-1-icon" alt="" src="<?php echo e(asset('images/send 1.svg')); ?>">

          					</div>
          					<div class="add-user-1-wrapper">
            						<img class="send-1-icon" alt="" src="<?php echo e(asset('images/add-user 1.png')); ?>">
      			...
      			<div class="lenovo-logosvg-parent">
                    <div class="logo-track">
                        <img src="<?php echo e(asset('images/Lenovo.svg')); ?>" alt="Lenovo">
                        <img src="<?php echo e(asset('images/Asus.svg')); ?>" alt="Asus">
                        <img src="<?php echo e(asset('images/Acer.svg')); ?>" alt="Acer">
                        <img src="<?php echo e(asset('images/Canon.svg')); ?>" alt="Canon">
                        <img src="<?php echo e(asset('images/Hp.svg')); ?>" alt="HP">
                    </div>
      			</div>
                <section id="service">
      		        <div class="frame-parent3" data-scroll-to="frameContainer2">
        				...
        				<div class="frame-parent4">
          					<div class="destination-1-parent">
            						<img class="destination-1-icon" alt="" src="<?php echo e(asset('images/destination 1.png')); ?>">
          					...
          					<div class="destination-1-parent">
            						<img class="destination-1-icon" alt="" src="<?php echo e(asset('images/cloudy 1.png')); ?>">
          					...
          					<div class="destination-1-parent">
            						<img class="destination-1-icon" alt="" src="<?php echo e(asset('images/booking 1.png')); ?>">
      			...
      			<div class="frame-parent5">
                        ...
                        <div class="frame-parent6" data-scroll-to="frameContainer1">
          					...
          					<div class="group-parent">
            						<div class="rectangle-group">
              							...
              							<img class="arrow-left-1-icon" alt="" src="<?php echo e(asset('images/arrow-left 1.svg')); ?>">

            						</div>
            						<div class="rectangle-container">
              							<div class="group-item">
              							</div>
              							<img class="arrow-left-2-icon" alt="" src="<?php echo e(asset('images/arrow-left 2.svg')); ?>">
            						</div>
          					</div>
        				</div>
                    </section>
                    <div class="project-track">
                        <div class="vector-group">
                            <img class="rectangle-icon" alt="" src="<?php echo e(asset('images/Rectangle 6.png')); ?>">
                            ...
                            <div class="vector-group">
                                <img class="frame-child1" alt="" src="<?php echo e(asset('images/Rectangle 6 (1).png')); ?>">
        				...
        				<div class="vector-group">
          					<img class="rectangle-icon" alt="" src="<?php echo e(asset('images/Rectangle 6 (2).png')); ?>">
        			...
        			<img class="background-icon" alt="" src="<?php echo e(asset('images/palang.svg')); ?>">
                    ...
                    <rect x="100" y="80" width="180" height="150" fill="url(#crossPattern)"/>
          					...
          					<div class="frame-parent15">
            						<div class="group-container">
              							<div class="rectangle-group">
                								...
                								<img class="icon-check" alt="" src="<?php echo e(asset('images/centang-oren.svg')); ?>">
            						...
            						<div class="group-parent1">
              							<div class="rectangle-group">
                								...
                								<img class="icon-check" alt="" src="<?php echo e(asset('images/centang-kuning.svg')); ?>">
            						...
            						<div class="group-parent1">
              							<div class="rectangle-group">
                								...
                								<img class="icon-check" alt="" src="<?php echo e(asset('images/centang-pink.svg')); ?>">
        				...
        				<img class="group-child2" alt="" src="<?php echo e(asset('images/Rectangle 9.png')); ?>">

        				<img class="group-child3" alt="" src="<?php echo e(asset('images/Rectangle 10.png')); ?>">
                    ...
                    <section id="contact">
        				...
        				<div class="frame-parent17">
          					<div class="message-1-parent">
            						<img class="send-1-icon" alt="" src="<?php echo e(asset('images/message 1.svg')); ?>">
      			...
      			<div class="frame-parent18">
        				<div class="frame-parent19">
          					...
          					<div class="group-parent">
            						<img class="group-icon" alt="" src="<?php echo e(asset('images/fb.svg')); ?>">

            						<img class="group-icon" alt="" src="<?php echo e(asset('images/twitter.svg')); ?>">

            						<img class="group-icon" alt="" src="<?php echo e(asset('images/Ig.svg')); ?>">
...
<?php /**PATH D:\Coding\private\pc shop\pc_shop\resources\views/welcome.blade.php ENDPATH**/ ?>